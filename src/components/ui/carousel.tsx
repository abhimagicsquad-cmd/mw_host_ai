...
function Carousel({
  ...
  React.useEffect(() => {
    if (!api) return
    // eslint-disable-next-line react-hooks/set-state-in-effect -- syncs initial button state once Embla's api is ready; required by Embla's documented usage pattern.
    onSelect(api)
