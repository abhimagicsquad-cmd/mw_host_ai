      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]">
        <div className="flex flex-col gap-6 rounded-2xl border border-border-alt bg-background p-6">
          <div className="flex items-start gap-3">
            <Phone className="mt-0.5 size-5 shrink-0 text-brand-orange" />
            <div>
              <p className="text-sm font-semibold text-brand-navy">Phone</p>
              <a href={contact.phoneHref} className="text-sm text-body-text hover:text-brand-orange">
                {contact.phone}
              </a>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <Mail className="mt-0.5 size-5 shrink-0 text-brand-orange" />
            <div>
              <p className="text-sm font-semibold text-brand-navy">Email</p>
              <a href={`mailto:${contact.email}`} className="text-sm text-body-text hover:text-brand-orange">
                {contact.email}
              </a>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <Clock className="mt-0.5 size-5 shrink-0 text-brand-orange" />
            <div>
